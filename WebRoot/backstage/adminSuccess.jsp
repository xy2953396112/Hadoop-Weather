...
<div class="nav-top">
    ...
    <div class="nav-topright">
    	...
    	%><%=time%></p>
        <span>您好：${user.username}</span><span><a href="<%=basePath%>login/removelogin">注销</a></span>
    </div>
</div>
<div class="nav-down">
	<div class="leftmenu1">
    	...
    	<ul>
        	<li>
                ...
                <div class="menu_list menu_list_first">
                	<a class="lista_first" href="<%=basePath%>login/showUsers" target="right">查看用户</a>
                    <a href="<%=basePath%>addUser.jsp" target="right">新增用户</a>
                    <a href="<%=basePath%>updateUser.jsp" target="right">修改用户</a>
                </div>
            </li>
            <li>
            	<a class="a_list a_list1">管理员设置</a>
                <div class="menu_list menu_list_first">
                	<a class="lista_first" href="<%=basePath%>login/showUsers" target="right">查看所有用户</a>
                    <a href="<%=basePath%>addAdmin.jsp" target="right">新增管理员</a>
                    <a href="<%=basePath%>updateAdmin.jsp" target="right">修改管理员</a>
            ...
            <li>
                ...
                <div class="menu_list">
                    ...
                    <a href="<%=basePath%>login/showTodayStatus" target="right">今天太原天气信息</a>
                    <a href="<%=basePath%>addWeather.jsp" target="right">天气信息增加</a>
                   <%--  <a href="<%=basePath%>showWeatherJSON.jsp" target="right">json</a> --%>
                    ...
                    <a href="<%=basePath%>showWeatherAPI.jsp" target="right">天气API信息查看</a>
            ...
            <li>
                ...
                <div class="menu_list">
                    ...
                    <a href="<%=basePath%>login/showTy_2014_week" target="right">太原2014年每周平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2015_week" target="right">太原2015年每周平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2016_week" target="right">太原2016年每周平均气温统计</a>
                    <a href="<%=basePath%>login/showCityMonth" target="right">城市三年月平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2014_quarter" target="right">太原2014年季度平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2015_quarter" target="right">太原2015年季度平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2016_quarter" target="right">太原2016年季度平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2014_year" target="right">太原2014年年平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2015_year" target="right">太原2015年年平均气温统计</a>
                    <a href="<%=basePath%>login/showTy_2016_year" target="right">太原2016年年平均气温统计</a>
                </div>
            </li>
             <li>
                ...
                <div class="menu_list">
                    ...
                    <%-- <a href="<%=basePath%>demo2.jsp" target="right">demo2.jsp</a> --%>
                    <a href="<%=basePath%>demo3.jsp" target="right">一周气温变化-折线图</a>
                    <a href="<%=basePath%>demo4.jsp" target="right">未来一周气温-折线图</a>
                    ...
                    <a href="<%=basePath%>test.jsp" target="right">浮动层</a>
                    <a href="<%=basePath%>rain.jsp" target="right">多种天气</a>
                    <a href="<%=basePath%>map.jsp" target="right">地图浏览器定位</a>
                    <a href="<%=basePath%>map_ip.jsp" target="right">地图Ip定位</a>
                    <a href="<%=basePath%>map_loc.jsp" target="right">地图经纬度定位</a>
                    <a href="<%=basePath%>map_search.jsp" target="right">天气驾车导航</a>
                </div>
            </li>
            <!--  
            <li>
        ...
        <ul>
        	<li>
                ...
                <div class="j_menu_list j_menu_list_first">
                    ...
                    <a class="lista_first" href="login/showUsers" target="right">查看用户</a>
                    <a href="<%=basePath%>addUser.jsp" target="right">新增用户</a>
                    <a href="<%=basePath%>updateUser.jsp" target="right">修改用户</a>
                </div>
            </li>
            <li>
                ...
                <div class="j_menu_list">
                	<span class="sp2"><i></i>地图</span>
                	<a href="<%=basePath%>map.jsp" target="right">地图浏览器定位</a>
                    <a href="<%=basePath%>map_ip.jsp" target="right">地图Ip定位</a>
                    <a href="<%=basePath%>map_loc.jsp" target="right">地图经纬度定位</a>
                    <a href="<%=basePath%>map_search.jsp" target="right">地图信息加检索定位</a>
                </div>
            </li>
            <li>
            	<a class="j_a_list j_a_list3"></a>
                <div class="j_menu_list">
                	<span class="sp3"><i></i>天气可视化展示</span>
                	<a href="<%=basePath%>demo1.jsp" target="right">雨量流量关系图</a>
                    <%-- <a href="<%=basePath%>demo2.html" target="right">天气小插件</a> --%>
                    <a href="<%=basePath%>demo3.jsp" target="right">一周气温变化</a>
    ...
    <div class="rightcon">
    	<div class="right_con">
            ...
            <h4>我是标题4。。。</h4>
            <h5>我是标题5。。。</h5> -->
            <iframe src="<%=basePath%>demo10.html" name="right" height="710px" width="100%"  style="background:#FFEFD5;">
                  <%-- <%@include file="<%=basePath%>demo11.html" %> --%>
            </iframe>
        </div>
    </div>
</div>
