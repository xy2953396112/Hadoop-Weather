...
<body>
	<div class="contact" >
		<form action="login/updateAdmin" method="post" >
			<ul>
				<li>
					<label>用户名：</label>
					<input type="text" name="username" value="${sessionScope.user.username}" placeholder="请输入用户名"  onblur="checkna()" required/><span class="tips" id="divname">长度1~12个字符</span>
				</li>
				<li>
					<label>修改密码：</label>
