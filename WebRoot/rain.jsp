...
$(document).ready(function(){
    //alert("start");
      ...
      $.ajax({
          type: "GET",
          url: "http://localhost:8080/Hadoop-Weather/login/showTodayStatus",           //url请求
          error:function(){ alert("没有今天的天气数据!"); },
          success: function(data){       //返回的数据
    	      console.log(data.showTodayStatus.weather);
        	  var weather = data.showTodayStatus.weather;        
        	  if(weather.indexOf("雪")>=0){   //返回的天气包含雪触发点击链接,下同
        		  $('#button-snow').click();
