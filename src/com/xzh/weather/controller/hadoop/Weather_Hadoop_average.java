...
import com.xzh.weather.controller.hadoop.Weather_Hadoop_average.WeatherMapper.WeatherReducer;





public class Weather_Hadoop_average {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(Weather_Hadoop_average.class);
